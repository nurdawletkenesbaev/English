  ...
  return (
    <div className='md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center py-2 z-50'>
      <div className='flex justify-around items-center'>
        ...
        {/* <div className='flex flex-col items-center text-xs px-2 py-1 rounded gap-[5px]'>
          <button
            onClick={() => {
...
function TopNav() {
  return (
    <nav className='hidden md:flex bg-white shadow px-4 py-3 gap-4 justify-center'>
      <Link className='text-purple-700 font-semibold' to='/'>
        Yangi
      </Link>
      <Link className='text-purple-700 font-semibold' to='/flashcard-new'>
        Flash (Yangi)
      </Link>
      <Link className='text-purple-700 font-semibold' to='/daily'>
        Takrorlash
      </Link>
      <Link className='text-purple-700 font-semibold' to='/all'>
        Barcha
      </Link>
      <Link className='text-purple-700 font-semibold' to='/stats'>
        Statistika
      </Link>
      {/* <button
        onClick={() => {
    ...
    <Router>
      <div className='min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 pb-20 md:pb-0'>
        ...
        <Routes>
          <Route
            path='/'
            element={<NewWords words={words} setWords={setWords} />}
          />
          <Route
            path='/flashcard-new'
            element={<FlashcardNew words={words} setWords={setWords} />}
          />
          <Route
            path='/daily'
            element={<DailyReview words={words} setWords={setWords} />}
          />
